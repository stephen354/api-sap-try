...
// Tangkap grant_type (dikirim dari SET_FORM_FIELD di ABAP)
...
if ($client_id !== $valid_id || $client_secret !== $valid_secret) {
    ...
    $response = ["pesan" => "Gagal, Client ID atau Secret salah!"];
...
if ($grant_type !== 'client_credentials') {
    ...
    $response = ["pesan" => "Gagal, grant_type salah!"];
...
// 3. Jika berhasil, kita kasih Token buatan kita
$response = [
